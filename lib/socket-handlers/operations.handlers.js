...
function register(socket, io, state) {
  ...
  socket.on('ops:scanContact', (data) => {
    try {
      ...
      socket.emit('ops:error', { message: 'Failed to scan contact', error: error.message });
  ...
  socket.on('ops:archiveMail', (data) => {
    try {
      ...
      socket.emit('ops:error', { message: 'Failed to archive mail', error: error.message });
    }
  });
  ...
  socket.on('ops:replyToMail', (data) => {
    try {
      ...
      socket.emit('ops:error', { message: 'Failed to send reply', error: error.message });
  ...
  socket.on('ops:addNPCCrew', (data) => {
    try {
      ...
      socket.emit('ops:error', { message: 'Failed to add NPC crew', error: error.message });
  ...
  socket.on('ops:updateNPCCrew', (data) => {
    try {
      ...
      socket.emit('ops:error', { message: 'Failed to update NPC crew', error: error.message });
  ...
  socket.on('ops:deleteNPCCrew', (data) => {
    try {
      ...
      socket.emit('ops:error', { message: 'Failed to delete NPC crew', error: error.message });
  ...
  socket.on('ops:getCombatState', () => {
    try {
      ...
      socket.emit('ops:error', { message: 'Failed to get combat state', error: error.message });
  ...
  socket.on('ops:enterCombat', (data) => {
    try {
      ...
      socket.emit('ops:error', { message: 'Failed to enter combat', error: error.message });
  ...
  socket.on('ops:exitCombat', (data) => {
    try {
      ...
      socket.emit('ops:error', { message: 'Failed to exit combat', error: error.message });
  ...
  socket.on('ops:getPrepData', (data) => {
    try {
      ...
      socket.emit('ops:error', { message: 'Failed to get prep data', error: error.message });
  ...
  socket.on('ops:addReveal', (data) => {
    try {
      ...
      socket.emit('ops:error', { message: 'Failed to add reveal', error: error.message });
  ...
  socket.on('ops:updateReveal', (data) => {
    try {
      ...
      socket.emit('ops:error', { message: 'Failed to update reveal', error: error.message });
  ...
  socket.on('ops:deleteReveal', (data) => {
    try {
      ...
      socket.emit('ops:error', { message: 'Failed to delete reveal', error: error.message });
  ...
  socket.on('ops:executeReveal', (data) => {
    try {
      ...
      socket.emit('ops:error', { message: 'Failed to execute reveal', error: error.message });
  ...
  socket.on('ops:revealNPC', (data) => {
    try {
      ...
      socket.emit('ops:error', { message: 'Failed to reveal NPC', error: error.message });
    }
  });
  ...
  socket.on('ops:revealLocation', (data) => {
    try {
      ...
      socket.emit('ops:error', { message: 'Failed to reveal location', error: error.message });
    }
  });
  ...
  socket.on('ops:triggerEvent', (data) => {
    try {
      ...
      socket.emit('ops:error', { message: 'Failed to trigger event', error: error.message });
  ...
  socket.on('ops:sendEmail', (data) => {
    try {
      ...
      socket.emit('ops:error', { message: 'Failed to send email', error: error.message });
    }
  });
  ...
  socket.on('ops:queueEmail', (data) => {
    try {
      ...
      socket.emit('ops:error', { message: 'Failed to queue email', error: error.message });
    }
  });
  ...
  socket.on('ops:shareHandout', (data) => {
    try {
      ...
      socket.emit('ops:error', { message: 'Failed to share handout', error: error.message });
    }
  });
