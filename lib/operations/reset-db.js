...
const { db, cleanupTestData, generateId } = require('./database');
const { seedDoranniaCampaign, CAMPAIGN } = require('./seed-dorannia');
...
// Step 3: Ensure Dorannia campaign exists
console.log('Step 3: Seeding Dorannia campaign...\n');
