...
const SHIP = {
  ...
  current_state: {
    ...
    systemHex: '1525',  // Dorannia hex in Spinward Marches
    locationId: 'loc-orbit-mainworld',  // Currently in orbit of Dorannia
    locationName: 'Orbit - Dorannia',  // Display name for UI
