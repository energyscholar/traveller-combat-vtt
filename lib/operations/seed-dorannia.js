/**
 * Seed Dorannia Escape Campaign for Bruce
 * Run with: node lib/operations/seed-dorannia.js
 *
 * Creates a complete campaign setup for the Bruce1Dorania use case:
 * - Campaign: Dorannia Escape (GM: Bruce)
 * - Ship: Kimbly (Type S Scout)
 * - 5 Player slots: James, Von Sydo, Max, Marina, Asao
 * - 1 NPC Pilot: Chance Dax
...
const SHIP = {
  ...
  ship_data: {
    ...
    weapons: [
      { type: 'pulse_laser', name: 'Pulse Laser', damage: '2d6', mount: 'turret' }
    ],
    sensors: 'Military',
    computer: 'Model/2'
  },
...
function seedDoranniaCampaign() {
  console.log('========================================');
  console.log('SEEDING DORANNIA ESCAPE CAMPAIGN');
